...
function New-DVColumn {
    ...
    param(
        ...
        [Parameter(Mandatory = $true, HelpMessage = "Type of the new field (Text, Memo, Integer, Decimal, Boolean, Date, DateTime, Choice, MultiChoice, Lookup, Polymorphic, Customer, Image)")]
        ...
        .EXAMPLE
            New-DVColumn -EnvironmentUrl "https://org.crm4.dynamics.com" -TableLogicalName "contact" `
        ...
        Export-ModuleMember -Function New-DVColumn

        # Examples:
        # 1. Add a new required text field "Project Code" (max 50 chars) to custom table 'new_project'
        # New-DVColumn -EnvironmentUrl $envUrl -TableLogicalName "new_project" -SchemaName "new_ProjectCode" `
